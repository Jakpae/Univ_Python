...
# Date : April 10, 2023
# Major features :
# - Prepare the user-defined module "MyMatrix.py " and implement 
# functions/methods printMtrx (name, M), addMtrx (mA, mB), subMtrx (mA, mB), 
# and mulMtrx (mA, mB) that perform matrix output, addition, subtraction, 
